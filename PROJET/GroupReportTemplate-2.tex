...
Lea CARMINATI Étudiant n° 22307644, Responsable rapport et de la partie
statistique.
...
\item
  ...
  \begin{figure}
  \centering
  \includegraphics[width=8cm,height=4cm]{MCD.png}
...
\begin{figure}
\centering
\includegraphics[width=10cm,height=7cm]{MOD.png}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#install.packages(c("sf", "ggplot2", "dplyr"))}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{departement }\OtherTok{\textless{}{-}} \FunctionTok{st\_read}\NormalTok{(}\StringTok{"https://raw.githubusercontent.com/codeforamerica/click\_that\_hood/master/public/data/france{-}departments.geojson"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{departement}\SpecialCharTok{$}\NormalTok{montant\_sa }\OtherTok{\textless{}{-}} \FunctionTok{sample}\NormalTok{(}\DecValTok{50000000}\SpecialCharTok{:}\DecValTok{30000000000}\NormalTok{, }\FunctionTok{nrow}\NormalTok{(departement), }\AttributeTok{replace =} \ConstantTok{TRUE}\NormalTok{)}

\FunctionTok{ggplot}\NormalTok{(departement) }\SpecialCharTok{+}
  \FunctionTok{geom\_sf}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{fill =}\NormalTok{ montant\_sa)) }\SpecialCharTok{+}
  \FunctionTok{scale\_fill\_viridis\_c}\NormalTok{(}\AttributeTok{option =} \StringTok{"plasma"}\NormalTok{, }\AttributeTok{trans =} \StringTok{"log"}\NormalTok{, }\AttributeTok{name =} \StringTok{"Montant salaire"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}
    \AttributeTok{title =} \StringTok{"Montant salaire par département en France"}
...
\begin{figure}
\centering
\includegraphics[width=15cm,height=10cm]{Nature_var_dep.png}
...
\begin{figure}
\centering
\includegraphics[width=15cm,height=9cm]{Nature_var_eta.png}
\caption{Code de la nature des variables dans la table
...
\begin{figure}
\centering
\includegraphics[width=15cm,height=9cm]{Nature_var_log.png}
\caption{Code de la nature des variables dans la table
...
\begin{figure}
\centering
\includegraphics[width=15cm,height=2cm]{hist_nbr_hab.png}
...
\begin{figure}
\centering
\includegraphics[width=15cm,height=2cm]{hist_nbr_log.png}
...
\begin{figure}
\centering
\includegraphics[width=15cm,height=9cm]{Nuage_de_point_revenu_chomage.png}
...
\begin{figure}
\centering
\includegraphics[width=15cm,height=9cm]{Nuage_de_point_revenu_pauvrete.png}
\caption{Code du nuage de points entre les revenu des salaires et le
...
\begin{figure}
\centering
\includegraphics[width=15cm,height=9cm]{Nuage_de_point_tauxlog_t_eta.png}
...
\begin{figure}
\centering
\includegraphics[width=15cm,height=1cm]{coeff_cor.png}
...
\begin{figure}
\centering
\includegraphics[width=15cm,height=1cm]{test_cor.png}
...
\begin{figure}
\centering
\includegraphics[width=15cm,height=5cm]{test_anova.png}
...
\begin{figure}
\centering
\includegraphics[width=15cm,height=5cm]{box_plot.png}
