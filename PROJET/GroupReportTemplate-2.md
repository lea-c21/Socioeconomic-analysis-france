...
\medskip
Lea CARMINATI Étudiant n° 22307644, Responsable rapport et de la  partie statistique.
...
- Pour le MCD, on inclut une image réalisée avec le logiciel Mocodo [https://www.mocodo.net/] visible sur la Figure$~$\ref{MCD} ci-dessous :
  ...
  ![MCD.](MCD.png){#MCD width="8cm" height="4cm"}
...
Pour le MOD, on inclut une image réalisée avec le designer de phpmyadmin, visible sur la Figure$~$\ref{MOD} ci-dessous :
  ...
  ![MOD.](MOD.png){#MOD width="10cm" height="7cm"}
...
```
## Warning: le package 'DBI' a été compilé avec la version R 4.4.3
```
...
```
## L'objet suivant est masqué depuis departement:
## 
##     code_dep
```
...
```
## L'objet suivant est masqué depuis etablissement:
## 
##     code_dep
```
...
## **Codes** {-}
 ...
 ![Code de la nature des variables dans la table Departement.](Nature_var_dep.png){#Nature width="15cm" height="10cm"}
 
 \medskip 
 
![Code de la nature des variables dans la table Etablissement.](Nature_var_eta.png){#Nature  width="15cm" height="9cm"}

 
 \medskip 
 

![Code de la nature des variables dans la table Logement.](Nature_var_log.png){#Nature  width="15cm" height="9cm"}

 
 \medskip 


![Code de l'histogramme du nombre d'habitants par département(nbr_hab).](hist_nbr_hab.png){#Histogramme width="15cm" height="2cm"}

\medskip


![Code de l'histogramme du nombre de logements par département(nbr_log).](hist_nbr_log.png){#Histogramme2 width="15cm" height="2cm"}

\medskip


![Code du nuage de points entre les revenu des salaires et le taux de chômage .](Nuage_de_point_revenu_chomage.png){#Nuage width="15cm" height="9cm"}

\medskip

![Code du nuage de points entre les revenu des salaires et le taux de pauvreté .](Nuage_de_point_revenu_pauvrete.png){#Nuage width="15cm" height="9cm"}

\medskip

![Code du nuage de points entre le taux de logements sociaux et le nombre total d'établissement .](Nuage_de_point_tauxlog_t_eta.png){#Nuage width="15cm" height="9cm"}


\medskip

![Code d'un exemple de coefficient de corrélation .](coeff_cor.png){#Correlation width="15cm" height="1cm"}

\medskip

![Code d'un exemple de test de  corrélation  .](test_cor.png){#Test_corr width="15cm" height="1cm"}

\medskip

![Code du test d'ANOVA .](test_anova.png){#ANOVA width="15cm" height="5cm"}

\medskip

![Code du box-plot.](box_plot.png){#Box_plot width="15cm" height="5cm"}
